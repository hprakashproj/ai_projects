...
def _get_embedding_collection_store(vector_dimension: Optional[int] = None) -> Any:
    ...
    class CollectionStore(Base):
        ...
        __tablename__ = "hellobuddy_pg_collection"
        __table_args__ = {'schema': 'schema_hellobuddy'}
    ...
    class EmbeddingStore(Base):
        ...
        __tablename__ = "hellobuddy_pg_embedding"
        ...
        collection_id = sqlalchemy.Column(
            ...
            sqlalchemy.ForeignKey(
                f"schema_hellobuddy.{CollectionStore.__tablename__}.uuid",
                ondelete="CASCADE",
            ),
        )
